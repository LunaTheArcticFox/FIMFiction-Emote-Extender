...
function initialize() {
	...
	if (sitePage == pageBlogEdit) {
		...
		$(".emoticons_panel").after("<p style='display: block;'><b>This part of the emote script is undergoing development. While it should be fully functional, the styling is actively being worked on and looks this way intentionally. Kind of.</b></p>");
	}
